...
lblTitle = Label(Tops, font=('arial', 30, 'bold'), text='Deposit money Rs. System', bd=15, bg='sky blue',
...
def iExit():
    iExit=tkinter.messagebox.askyesno("Exit Deposit System", "Confirm if you want to exit")
    if iExit > 0:
        root.destroy()
        return
