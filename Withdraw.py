...
lblTitle = Label(Tops, font=('arial', 30, 'bold'), text='Withdraw  money Rs. System', bd=15, bg='sky blue',
...
def iExit():
    iExit=tkinter.messagebox.askyesno("Exit withdraw System", "Confirm if you want to exit")
    if iExit > 0:
        root.destroy()
        return
...
def TotalofUnit():
    ...
    Prices_Drinks = (Unit1 * 2000) + (Unit2 * 500) + (Unit3 * 200) + (Unit4 * 100) + (Unit5 * 50) + (Unit6 * 20) + (Unit7 * 10) + (Unit8 * 5)

    Prices_Food = (Unit9 * 10) + (Unit10 * 5) + (Unit11 * 2) + (Unit12 * 1) + (Unit13 * 0) + (Unit14 * 0) + (Unit15 * 0) + (Unit16 * 0)
...
# change p to Rs.
    ...
    Sub_Total_of_Unit = "Rs" + str('%.2f'%(Prices_Drinks + Prices_Food + 0.00))
    SubTotal.set(Sub_Total_of_Unit)

    Tax = "Rs" + str('%.2f'%((Prices_Drinks + Prices_Food + 0.00) * 0.00))
    PaidTax.set(Tax)

    TT = ((Prices_Drinks + Prices_Food + 0.00) * 0.00)
    TC = "Rs" + str('%.2f'%(Prices_Drinks + Prices_Food + 0.00 + TT))
    TotalCost.set(TC)
...
# Drinks (change text and type numbers)
Cocktail = Checkbutton(Drinks_Function, text='2000', variable=variable1, onvalue=1, offvalue=0, font=('arial', 16, 'bold'),
                    bg='sky blue', command=drinksCocktail).grid(row=0, sticky=W)
IcedTea = Checkbutton(Drinks_Function, text='500', variable=variable2, onvalue=1, offvalue=0, font=('arial', 16, 'bold'),
                    bg='sky blue', command=drinksIceTea).grid(row=1, sticky=W)
HotChocolate = Checkbutton(Drinks_Function, text='200', variable=variable3, onvalue=1, offvalue=0, font=('arial', 16, 'bold'),
                    bg='sky blue', command=drinksHotChocolate).grid(row=2, sticky=W)
OrangeJuice = Checkbutton(Drinks_Function, text='100', variable=variable4, onvalue=1, offvalue=0, font=('arial', 16, 'bold'),
                    bg='sky blue', command=drinksOrangeJuice).grid(row=3, sticky=W)
MilkShake = Checkbutton(Drinks_Function, text='50', variable=variable5, onvalue=1, offvalue=0, font=('arial', 16, 'bold'),
                    bg='sky blue', command=drinksMilkShake).grid(row=4, sticky=W)
MountainDew = Checkbutton(Drinks_Function, text='20', variable=variable6, onvalue=1, offvalue=0, font=('arial', 16, 'bold'),
                    bg='sky blue', command=drinksMountainDew).grid(row=5, sticky=W)
Sting = Checkbutton(Drinks_Function, text='10', variable=variable7, onvalue=1, offvalue=0, font=('arial', 16, 'bold'),
                    bg='sky blue', command=drinksSting).grid(row=6, sticky=W)
Cobra = Checkbutton(Drinks_Function, text='5', variable=variable8, onvalue=1, offvalue=0, font=('arial', 16, 'bold'),
...
# Foods CHANGE NAME AND TYPE NUMBER

FriedChicken = Checkbutton(Food_Function,text="COIN 10\t\t\t ",variable=variable9,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='sky blue',command=foodsFriedChicken).grid(row=0,sticky=W)
KareKare = Checkbutton(Food_Function,text="COIN 5",variable=variable10,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='sky blue',command=foodsKareKare).grid(row=1,sticky=W)
CrispyPata = Checkbutton(Food_Function,text="COIN 2 ",variable=variable11,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='sky blue',command=foodsCrispyPata).grid(row=2,sticky=W)
SinigangBaboy = Checkbutton(Food_Function,text="COIN 1 ",variable=variable12,onvalue = 1, offvalue=0,
...
# ToTal Cost
lblTotalofDrinks=Label(Total_Function,font=('arial',14,'bold'),text='Total of IN RS.\t',bg='sky blue',fg='black',justify=CENTER)
lblTotalofDrinks.grid(row=0,column=0,sticky=W)
textTotalofDrinks=Entry(Total_Function,bg='green', fg='white',bd=7,font=('arial',14,'bold'),insertwidth=2,justify=RIGHT,textvariable=Total_of_Drinks)
...
lblTotalofFood=Label(Total_Function,font=('arial',14,'bold'),text='Total of COIN  ',bg='sky blue',fg='black',justify=CENTER)
lblTotalofFood.grid(row=1,column=0,sticky=W)
textTotalofFood=Entry(Total_Function,bg='green',fg='white',bd=7,font=('arial',14,'bold'),insertwidth=2,justify=RIGHT,textvariable=Total_of_Food)
...
textSubTotal=Entry(Total_Function,bg='green',fg='white',bd=7,font=('arial',14,'bold'), insertwidth=2,justify=RIGHT,textvariable=SubTotal)
...
textTotalCost=Entry(Total_Function,bg='green', fg='white',bd=7,font=('arial',14,'bold'),insertwidth=2,justify=RIGHT,textvariable=TotalCost)
